...
for n in {1..30}; do 
    for file in /lfs1/usrscratch/mtech/cs22m036/mtx/*.mtx; do
        ...
        ./bin/swell_32 mtx "$full_file_no_ext" >> "${filename_no_ext}_spmv_swell_32_nop.txt" 
        ./bin/spmv_base mtx "$full_file_no_ext" >> "${filename_no_ext}_spmv_base_nop.txt" 
        ./bin/spmv_opt mtx "$full_file_no_ext" >> "${filename_no_ext}_spmv_bitonic.txt" 
